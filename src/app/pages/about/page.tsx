    ...
    return (
        <main>
            ...
            <div className='aboutContainer'>
                ...
                <p>At Bloom Blog, we embrace the beauty of words and the profound impact they carry. This platform is not just a space; it is a garden where ideas bloom, stories flourish, and voices resonate. Here, we celebrate the art of expression in all its forms.</p>
                <p>Our mission is to provide a nurturing space for writers of every background, experience, and perspective. Whether you are a seasoned wordsmith or just starting your journey, Bloom Blog is where your creativity takes root and grows.</p>
